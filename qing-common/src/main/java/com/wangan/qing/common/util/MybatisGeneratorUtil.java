...
import static com.wangan.qing.common.util.StringUtil.lineToHump;
...
public class MybatisGeneratorUtil {
	...
	public static void generator(
		...
		System.out.printf(MybatisGeneratorUtil.class.getResource("/").getPath());
		String basePath = MybatisGeneratorUtil.class.getResource("/").getPath().replace("/target/classes/", "").replace("qing-umps-dao","");
		...
		try {
			...
			String targetProjectSqlMap = basePath + module + "/" + module + "qing-rpc-service";
		...
		String servicePath = basePath + module + "/" + module + "qing-upms-rpc-api" + "/src/main/java/" + packageName.replaceAll("\\.", "/") + "/rpc/api";
		String serviceImplPath = basePath + module + "/" + module + "qing-upms-service" + "/src/main/java/" + packageName.replaceAll("\\.", "/") + "/service/rpc/service/impl";
